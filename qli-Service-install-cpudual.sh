...
qubicService=qlic.service
settingsFile=appsettings.json

#stop service if it is running
systemctl is-active --quiet qlic && systemctl stop --no-block qlic
...
sed -i 's/q/qc/g' $path/$serviceScript
sed -i 's/qcl/ql/g' $path/$serviceScript
